...
from .transformer_1dcnn import TransformerEncoder_1dcnn, TransformerDecoder_1dcnn, \
    TransformerEncoderLayer_1dcnn, TransformerDecoderLayer_1dcnn, Transformer_1dcnn
...
__all__ = [
    ...
    'TransformerEncoderLayer', 'TransformerDecoderLayer', 'Transformer', 'TransformerEncoderLayer_1dcnn',
    'TransformerEncoder_1dcnn', 'TransformerDecoder_1dcnn', 'TransformerEncoderLayer_1dcnn',
    'TransformerDecoderLayer_1dcnn', 'Transformer_1dcnn',
